...
const (
	RecommendationService_SendUserAction_FullMethodName     = "/recommendation.RecommendationService/SendUserAction"
	RecommendationService_GetRecommendations_FullMethodName = "/recommendation.RecommendationService/GetRecommendations"
	RecommendationService_SendAllBoardgames_FullMethodName  = "/recommendation.RecommendationService/SendAllBoardgames"
)
...
type RecommendationServiceClient interface {
	SendUserAction(ctx context.Context, in *UserAction, opts ...grpc.CallOption) (*Response, error)
	GetRecommendations(ctx context.Context, in *RecommendationRequest, opts ...grpc.CallOption) (*RecommendationResponse, error)
	SendAllBoardgames(ctx context.Context, in *BoardgamesRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *recommendationServiceClient) SendUserAction(ctx context.Context, in *UserAction, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, RecommendationService_SendUserAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recommendationServiceClient) SendAllBoardgames(ctx context.Context, in *BoardgamesRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, RecommendationService_SendAllBoardgames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecommendationServiceServer interface {
	SendUserAction(context.Context, *UserAction) (*Response, error)
	GetRecommendations(context.Context, *RecommendationRequest) (*RecommendationResponse, error)
	SendAllBoardgames(context.Context, *BoardgamesRequest) (*Response, error)
...
func (UnimplementedRecommendationServiceServer) SendUserAction(context.Context, *UserAction) (*Response, error) {
...
func (UnimplementedRecommendationServiceServer) SendAllBoardgames(context.Context, *BoardgamesRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendAllBoardgames not implemented")
}
...
func _RecommendationService_SendUserAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserAction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).SendUserAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_SendUserAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).SendUserAction(ctx, req.(*UserAction))
	}
...
func _RecommendationService_SendAllBoardgames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BoardgamesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).SendAllBoardgames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_SendAllBoardgames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).SendAllBoardgames(ctx, req.(*BoardgamesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RecommendationService_SendUserAction_Handler,
		},
		{
		...
		{
			MethodName: "SendAllBoardgames",
			Handler:    _RecommendationService_SendAllBoardgames_Handler,
		},
	},
