...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendUserAction = channel.unary_unary(
                '/recommendation.RecommendationService/SendUserAction',
                request_serializer=recommendation__pb2.UserAction.SerializeToString,
                response_deserializer=recommendation__pb2.Response.FromString,
        ...
        self.GetRecommendations = channel.unary_unary(
                ...
                _registered_method=True)
        self.SendAllBoardgames = channel.unary_unary(
                '/recommendation.RecommendationService/SendAllBoardgames',
                request_serializer=recommendation__pb2.BoardgamesRequest.SerializeToString,
                response_deserializer=recommendation__pb2.Response.FromString,
                _registered_method=True)
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendUserAction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=recommendation__pb2.UserAction.FromString,
                    response_serializer=recommendation__pb2.Response.SerializeToString,
            ),
            ...
            'SendAllBoardgames': grpc.unary_unary_rpc_method_handler(
                    servicer.SendAllBoardgames,
                    request_deserializer=recommendation__pb2.BoardgamesRequest.FromString,
                    response_serializer=recommendation__pb2.Response.SerializeToString,
            ),
    }
...
class RecommendationService(object):
    ...
    def SendUserAction(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/recommendation.RecommendationService/SendUserAction',
            recommendation__pb2.UserAction.SerializeToString,
            recommendation__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendAllBoardgames(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/recommendation.RecommendationService/SendAllBoardgames',
            recommendation__pb2.BoardgamesRequest.SerializeToString,
            recommendation__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
